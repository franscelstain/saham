...
class PreopenContractTest extends TestCase
{
    ...
    public function test_fixture_weekly_swing_with_capital_is_valid(): void
    {
        $payload = json_decode(file_get_contents(base_path('tests/Fixtures/watchlist/preopen_weekly_swing_with_capital.json')), true);
        $this->assertIsArray($payload);
