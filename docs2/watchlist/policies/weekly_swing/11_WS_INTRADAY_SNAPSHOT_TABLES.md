...
- Jika `NOW() - effective_captured_at > 900 detik` → snapshot **EXPIRED** → CONFIRM wajib downgrade menjadi **DELAY** (atau NO_TRADE sesuai policy), dan wajib mengeluarkan reason `WS_STALE`.
