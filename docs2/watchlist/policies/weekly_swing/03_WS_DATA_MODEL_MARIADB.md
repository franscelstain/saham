...
Bagian ini mengunci bagaimana data yang dipersist ke tabel global dipetakan ke runtime output (API/UI) yang didefinisikan di [`_refs/WS_RUNTIME_OUTPUT_SCHEMA.md`](_refs/WS_RUNTIME_OUTPUT_SCHEMA.md).
