...
Dokumen ini adalah governance tertinggi domain watchlist. Dokumen ini menetapkan hierarchy source of truth, aturan konflik, ownership domain, dan klasifikasi dokumen normatif versus dokumen pendukung di seluruh `docs/watchlist/`.

## Scope

Dokumen ini berlaku untuk seluruh struktur di bawah `docs/watchlist/`, termasuk:
...
4. aturan lintas strategy di `docs/watchlist/policies/_shared/`
5. `_refs/`
6. `examples/`
7. `fixtures/`
...
Hal-hal berikut tetap dimiliki secara authoritative oleh `docs/market_data/`:
