...
1) **Dokumen root** di [`docs/watchlist/`](./README.md) (mis. [`policy.md`](policy.md), [`README.md`](README.md), dokumen ini) boleh menyebut path repo-root dengan prefix `docs/...` untuk menegaskan root scope.

2) **Dokumen selain root** (mis. `docs/watchlist/policies/**`, `docs/watchlist/db/**`) wajib memakai **path relatif** dari lokasi file tersebut.
