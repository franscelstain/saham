...
Sebuah application service dianggap sehat bila jawaban untuk pertanyaan berikut jelas:

- Apakah tujuan use case-nya spesifik?
- Apakah input dan output-nya eksplisit?
- Apakah service bebas dari query langsung?
- Apakah service bebas dari detail persistence?
- Apakah rule domain berat berada di domain compute, bukan di service?
- Apakah transaction boundary jelas?
- Apakah error handling tetap berada di level aplikasi, bukan level response publik?
- Apakah service tidak tumbuh menjadi god service?
- Apakah dependency yang dipakai memang sesuai perannya?
- Apakah implementasinya masih mudah diuji secara fokus?
