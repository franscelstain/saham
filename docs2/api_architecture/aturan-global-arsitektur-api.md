...
## Checklist review global

Sebuah desain arsitektur dianggap sehat bila jawaban untuk pertanyaan berikut jelas:

- Apakah setiap concern besar punya rumah yang jelas?
- Apakah request mentah berhenti di transport boundary?
- Apakah query hanya ada di persistence layer?
- Apakah rule domain utama berada di domain compute?
- Apakah service hanya mengorkestrasi?
- Apakah DTO hanya membawa data?
- Apakah response publik dibentuk di rumah yang benar?
- Apakah handoff antar layer eksplisit?
- Apakah performa, idempotensi, dan logging mengikuti boundary yang benar?
- Apakah pengecualian, bila ada, tetap sempit dan terdokumentasi?
