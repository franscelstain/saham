...
Sebuah DTO dianggap sehat bila jawaban untuk pertanyaan berikut jelas:

- Apakah object ini benar-benar hanya membawa data?
- Apakah perannya sebagai request, filter, result, atau response jelas?
- Apakah tidak ada query, service call, atau side effect?
- Apakah hanya validasi bentuk yang ada di dalamnya?
- Apakah rule bisnis berada di tempat lain yang lebih tepat?
- Apakah shape field eksplisit dan stabil?
- Apakah array bebas tidak dipakai untuk menggantikan kontrak DTO resmi?
- Apakah DTO ini tidak menyelundupkan detail framework atau persistence?
- Apakah perubahan terhadap DTO akan terlihat sebagai perubahan kontrak?
- Apakah object ini tetap masuk akal bila diuji secara terpisah tanpa dependency teknis?
