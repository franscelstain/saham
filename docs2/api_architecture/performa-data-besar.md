...
Sebuah desain akses data besar dianggap sehat bila jawaban untuk pertanyaan berikut jelas:

- Apakah strategi aksesnya sesuai dengan ukuran data?
- Apakah full load dihindari bila tidak perlu?
- Apakah N+1 dicegah di persistence layer?
- Apakah chunking, streaming, pagination, atau cursor access dipilih secara sadar?
- Apakah bulk write dipakai bila lebih tepat daripada item-per-item?
- Apakah read model atau precompute dipakai dengan alasan yang jelas?
- Apakah profiling dan benchmark minimum sudah dilakukan?
- Apakah transaction boundary untuk operasi besar masih masuk akal?
- Apakah partial failure dan rerun strategy jelas?
- Apakah desain ini masih masuk akal saat volume data tumbuh?
