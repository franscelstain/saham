...
Sebuah handoff antar layer dianggap sehat bila jawaban untuk pertanyaan berikut jelas:

- Apakah payload utamanya eksplisit?
- Apakah bentuk payload stabil?
- Apakah concern layer asal tidak bocor ke layer tujuan?
- Apakah request framework berhenti di transport boundary?
- Apakah model persistence mentah tidak bocor lintas layer?
- Apakah payload bebas dari lazy loading dan query tersembunyi?
- Apakah perubahan shape payload akan terlihat sebagai perubahan kontrak?
- Apakah mapper, bila ada, tetap bersih dari query dan rule bisnis berat?
- Apakah layer penerima dapat memakai payload tanpa menebak-nebak isi tersembunyi?
- Apakah handoff ini masih masuk akal bila diuji secara terpisah dari framework dan persistence?
