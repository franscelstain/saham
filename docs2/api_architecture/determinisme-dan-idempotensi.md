...
Sebuah operasi dianggap sehat terhadap determinisme dan idempotensi bila jawaban untuk pertanyaan berikut jelas:

- Apakah operasi ini dinyatakan idempotent, semi-idempotent, atau non-idempotent?
- Apakah identitas operasinya jelas?
- Apakah retry aman?
- Apakah rerun aman?
- Apakah duplicate request atau duplicate event dapat dideteksi?
- Apakah partial failure dapat dijelaskan dan ditangani?
- Apakah transaksi, lock, atau unique constraint dipakai secara tepat?
- Apakah sumber waktu, urutan, dan random yang relevan dikendalikan?
- Apakah batch dan async flow punya checkpoint atau strategi deduplication yang jelas?
- Apakah hasil operasi masih dapat ditelusuri dan diaudit?
