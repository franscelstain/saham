...
Sebuah domain compute dianggap sehat bila jawaban untuk pertanyaan berikut jelas:

- Apakah logic yang ada benar-benar keputusan bisnis murni?
- Apakah inputnya fokus dan eksplisit?
- Apakah outputnya fokus dan eksplisit?
- Apakah tidak ada query database?
- Apakah tidak ada request framework atau response publik final?
- Apakah logic ini seharusnya memang bukan orchestration service?
- Apakah hasilnya deterministik terhadap input dan policy yang sah?
- Apakah threshold, weight, atau policy yang memengaruhi hasil dapat ditelusuri?
- Apakah rule bisnis utama tidak tercecer di repository, service, atau controller?
- Apakah komponen ini tetap mudah diuji secara fokus?
