...
Sebuah transport boundary dianggap sehat bila jawaban untuk pertanyaan berikut jelas:

- Apakah request mentah berhenti di boundary transport?
- Apakah validasi bentuk dilakukan dengan jelas?
- Apakah auth dan authz boundary ditangani di tempat yang tepat?
...
- Apakah repository tidak dipanggil langsung tanpa alasan resmi?
- Apakah error transport dipetakan secara konsisten?
- Apakah uploaded file, header, query param, dan body ditangani dengan boundary yang jelas?
- Apakah perubahan protokol atau framework tidak memaksa layer bawah ikut berubah?
