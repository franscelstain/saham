...
Sebuah repository dianggap sehat bila jawaban untuk pertanyaan berikut jelas:

- Apakah semua query resmi berada di persistence layer?
- Apakah repository bebas dari rule bisnis utama?
- Apakah input repository eksplisit?
- Apakah output repository eksplisit dan inert?
- Apakah layer di atas tidak perlu tahu detail tabel atau query?
- Apakah tidak ada lazy loading tersembunyi yang bocor ke layer lain?
- Apakah access pattern besar seperti pagination, streaming, chunking, dan bulk operation punya kontrak jelas?
- Apakah transaction boundary tetap jelas?
- Apakah error persistence diperlakukan dengan benar?
- Apakah repository masih fokus dan tidak berubah menjadi god component?
