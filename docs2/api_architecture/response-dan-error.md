...
Sebuah implementasi response dan error dianggap sehat bila jawaban untuk pertanyaan berikut jelas:

- Apakah shape sukses konsisten?
- Apakah shape error konsisten?
- Apakah kode error stabil?
- Apakah mapping ke status transport jelas?
- Apakah informasi sensitif tidak bocor?
- Apakah response layer bebas query dan bebas rule bisnis baru?
- Apakah perubahan output diperlakukan sebagai perubahan kontrak?
- Apakah test kontrak response dapat dibuat dari aturan ini?
